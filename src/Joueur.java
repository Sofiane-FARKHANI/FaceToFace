...
public class Joueur {
	 ...
	 * @return : retourne l etat du joueur
	 * 		true 	: le joueur est en vie
	 * 		false 	: le joueur a perdu la partie
	 */
	...
	/**
	 * Methode permettant de changer d etat le joueur
	 * Passe le joueur de l etat en vie à mort
	 * 
